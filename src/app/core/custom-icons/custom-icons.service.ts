...
export class CustomIconsService {
  ...
  init(): void {
    ...
    this.registerIcons(
      ["angular-logo-2", "angular-logo"],
      "/assets/icons/logos/"
    );
    this.registerIcons(
      ["dashboards", "forms", "components", "charts", "tables", "utilities"],
    ...
    this.registerIcons(
      ["calendar", "arrow-up", "arrow-down", "half-arrow-down", "drag"],
      "/assets/icons/dashboards/crm/"
    );
    this.registerIcons(
      [
        "sales",
